...
The Sensirion gas index algorithm expects a 1 Hz sampling rate. Both indices
will be 0 during the first ~45 s warm-up and then settle in the range 1..500
(VOC baseline 100, NOx baseline 1). Pair with a BME280 (or similar) for
